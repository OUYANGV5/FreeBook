...
public class CategoryBookListFragment extends BaseFragment {
    ...
    public static CategoryBookListFragment newInstance(String sort, String categoryId, String tag){
        CategoryBookListFragment rankBookListFragment = new CategoryBookListFragment();
        rankBookListFragment.typeSort=sort;
        rankBookListFragment.categoryId=categoryId;
